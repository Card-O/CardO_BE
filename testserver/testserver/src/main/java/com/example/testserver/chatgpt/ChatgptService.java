...
public class ChatgptService {
    ...
    public String makeTranslationPrompt(String target) {
        ...
        //return target + " 이미지 생성 프롬프트를 한 줄로 작성해줘. DALL-E에 적용할 것이고, 퀄리티 있는 사진을 원해. 영어로 대답해줘.";
    }

    public String makeImagePrompt(String translatedtext,String atmosphere) {
        //return "clean page from a coloring book for children" + translatedtext + ", with a "+atmosphere+" mood. no text no numbers.";
